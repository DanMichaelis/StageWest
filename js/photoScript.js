...
for (let t = 0; t <= images.length - 1; t++) {
  ...
  if (t === 0) {
    $('#imgZone').append('<li class="slide" data-active ><img style="width: 100%" src="img/photos/' + images[t].name + '" alt="' + images[t].pos + '"></li>')

  } else {

    $('#imgZone').append('<li class="slide"><img style="width: 100%" src="img/photos/' + images[t].name + '" alt="' + images[t].pos + '"></li>')
  }
